...
When creating Mule applications in Design Center, the top navbar shows the state of your application. It also displays alerts about possible runtime errors.
